...
const Office = () => {
  ...
  const sectionData = {
    legal: {
      ...
      content: {
        "Mandate and Core Functions":
          "The Legal Unit is responsible for providing legal advisory services, handling litigation, drafting legal documents, and ensuring compliance with regulatory requirements.",
    ...
    protocol: {
      title:
        "Protocol, Press, and Public Relations Unit – National Senior Secondary Education Commission (NSSEC)",
      head: "Fatima Bappare",
      vision:
        "To establish a result-oriented and media-friendly Public Relations Unit that fosters positive engagement with stakeholders while enhancing the Commission's public image in line with its objectives.",
      mission:
        "To cultivate sustainable and mutually beneficial relationships between NSSEC, the media, and the general public through effective service delivery and strategic communication.",
      content: {
        "Core Mandate":
          "The unit focuses on three key areas: Publicity, Publications, and New Media.",
        Publicity: [
    ...
    procurement: {
      ...
      head: "Abdulazeez Abdulkadeer Maikanti ",
      vision:
        "To deliver impactful projects and ensure seamless procurement processes that align with global standards and best practices, integrating innovation, efficiency, and sustainability.",
      mission:
        "To support NSSEC's mission of driving excellence in education, technology, and infrastructure development through strategic project management and transparent procurement processes.",
      content: {
        "Projects Overview":
          "NSSEC leads and manages various strategic initiatives aimed at fostering national development across multiple sectors.",
    ...
    physical: {
      ...
      head: "Arc. Maimuna Lami",
      vision:
        "To create and maintain world-class physical infrastructure and strategic planning frameworks that support NSSEC's educational mission and ensure optimal resource utilization.",
      mission:
        "To provide comprehensive physical planning, infrastructure development, and facility management services that enhance the Commission's operational efficiency and educational delivery.",
      content: {
        "Core Functions":
          "The Physical and Planning Unit is responsible for infrastructure development, facility management, and strategic physical planning across all NSSEC operations.",
        "Infrastructure Development": [
    ...
    actu: {
      ...
      head: "OKWORI MARY FAVOUR",
      vision:
        "To establish efficient service delivery mechanisms and maintain high standards of public service through effective anti-corruption measures and service improvement initiatives.",
      mission:
        "To ensure transparency, accountability, and excellence in service delivery while combating corruption and promoting ethical conduct within NSSEC operations.",
      content: {
        "ACTU (Anti-Corruption and Transparency Unit)":
          "Dedicated to promoting transparency, accountability, and ethical conduct in all NSSEC operations.",
        ...
        "SERVICOM (Service Compact with Nigerians)":
          "Committed to improving service delivery and customer satisfaction across all NSSEC services.",
        "Service Improvement": [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-[#24c2c2]/10 to-[#24c2c2]/5 rounded-lg p-6 mb-8">
          ...
          <div className="bg-white rounded-md p-4 mb-4 shadow-sm border-l-4 border-[#24c2c2]">
            ...
            <p className="text-lg text-[#24c2c2] font-medium">
              {currentData.head}
            </p>
          </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-[#24c2c2] to-[#20b5b5] rounded-lg p-8 text-center">
          <h3 className="text-2xl font-bold text-white mb-4">
            ...
            {activeSection === "protocol" &&
              "Building Stronger Public Relations"}
            {activeSection === "procurement" &&
              "Driving Innovation Through Strategic Procurement"}
            {activeSection === "physical" &&
              "Building the Future of Education Infrastructure"}
            {activeSection === "actu" &&
              "Promoting Transparency and Service Excellence"}
          </h3>
          <p className="text-[#24c2c2]/90 text-lg mb-6 max-w-2xl mx-auto">
            ...
            {activeSection === "protocol" &&
              "The Protocol, Press, and Public Relations Unit is integral to NSSEC's operations, ensuring transparent communication, efficient media relations, and seamless protocol management."}
            {activeSection === "procurement" &&
              "We welcome reputable vendors, contractors, and partners to participate in our procurement processes. Opportunities are announced through official channels, ensuring fairness and inclusivity."}
            {activeSection === "physical" &&
              "Creating sustainable and innovative physical infrastructure that supports educational excellence and operational efficiency across all NSSEC facilities."}
            {activeSection === "actu" &&
              "Committed to maintaining the highest standards of transparency, accountability, and service delivery in all NSSEC operations."}
          </p>
